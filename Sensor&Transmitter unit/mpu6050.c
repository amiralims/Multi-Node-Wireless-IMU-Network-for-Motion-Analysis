...
void mpu6050_init(uint8_t gy_range, uint8_t ac_range) {
    ...
    //set sampe rate
	mpu6050_writeByte(MPU6050_RA_SMPLRT_DIV, 1); //8khz / (1 + 1) = 4kHz
	//set gyro range
	mpu6050_writeBits(MPU6050_RA_GYRO_CONFIG, MPU6050_GCONFIG_FS_SEL_BIT, MPU6050_GCONFIG_FS_SEL_LENGTH, gy_range);
	//set accel range
	mpu6050_writeBits(MPU6050_RA_ACCEL_CONFIG, MPU6050_ACONFIG_AFS_SEL_BIT, MPU6050_ACONFIG_AFS_SEL_LENGTH, ac_range);
	//set I2c CLK speed
	mpu6050_writeBits(MPU6050_RA_I2C_MST_CTRL, MPU6050_I2C_MST_CLK_BIT, MPU6050_I2C_MST_CLK_LENGTH, MPU6050_CLOCK_DIV_400);
	//enable data ready interrupt
	mpu6050_writeBit(MPU6050_RA_INT_ENABLE, 0, 1);
}
